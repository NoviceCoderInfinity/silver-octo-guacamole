...
CAPTION_ASSEMBLY = os.environ.get("CAPTION_ASSEMBLY", "portfolio_select").strip().lower()

# Deterministic post-caption safety refilter (no extra model calls).
ENABLE_OUTPUT_SAFETY = os.environ.get("ENABLE_OUTPUT_SAFETY", "true").strip().lower() not in ("false", "0", "no", "")
