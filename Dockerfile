...
COPY config.py video_utils.py llm_client.py pipeline.py output_safety.py main.py ./
...
ARG CAPTION_ASSEMBLY="portfolio_select"
ENV CAPTION_ASSEMBLY=${CAPTION_ASSEMBLY}
ARG ENABLE_OUTPUT_SAFETY="true"
ENV ENABLE_OUTPUT_SAFETY=${ENABLE_OUTPUT_SAFETY}
